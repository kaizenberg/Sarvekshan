            ...
            "elements": [
                {
                    ...
                    "name": "Intro",
                    "html": {
                        "default": "<P>This self-assessment suggests further steps depending on your level of risk of exposure to COVID-19 (Novel Coronavirus).</p><p>You can complete this form for yourself or others who are not able.</P>\n<p>\n<a id=\"changeLanguageAnchor\" href=\"javascript:toggleLanguage();\">हिंदी के लिए यहाँ क्लिक करें<a/>\n</p>",
                        "es": "<P>यह स्व-निर्धारण COVID-19 (नोवेल कोरोनावायरस) संक्रमण के जोखिम के आपके स्तर के आधार पर आगे के चरणों का सुझाव देता है।</p><p>आप इस प्रपत्र को अपने या अन्य लोगों के लिए पूरा कर सकते हैं जो सक्षम नहीं हैं।</P>\n<p>\n<a id=\"changeLanguageAnchor\" href=\"javascript:toggleLanguage();\">Click here for English<a/>\n</p>"
                    }
                }
            ],
            "readOnly": true

...
This web tool is a PoC for showcasing how technology can be used to fight COVID-19 spread by identifying and tracking movement of people post lock-down without compromising their privacy. This should allow lifting of lock down restrictons for people who may not be infected, like essential-services/health/supply-chain workers, especially considering that 21 days of lockdown are already over.
